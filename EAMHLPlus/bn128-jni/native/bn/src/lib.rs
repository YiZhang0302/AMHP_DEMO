...
impl Gt {
    ...
    pub fn new(value: fields::Fq12) -> Self {
        Gt(value)
    }

    pub fn pow(&self, exp: Fr) -> Gt {
        let result = self.0.pow(exp.0);
        // println!("self:{:?}", self.0);
        // println!("reust:{:?}", result);
        // result
        Gt(result)
    }
    ...
    pub fn get_ci(&self) -> [Fq; 12] {
        let c0 = Fq(self.0.c0.c0.c0.clone());
        let c1 = Fq(self.0.c0.c0.c1.clone());
        let c2 = Fq(self.0.c0.c1.c0.clone());
        let c3 = Fq(self.0.c0.c1.c1.clone());
        let c4 = Fq(self.0.c0.c2.c0.clone());
        let c5 = Fq(self.0.c0.c2.c1.clone());

        let c6 = Fq(self.0.c1.c0.c0.clone());
        let c7 = Fq(self.0.c1.c0.c1.clone());
        let c8 = Fq(self.0.c1.c1.c0.clone());
        let c9 = Fq(self.0.c1.c1.c1.clone());
        let c10 = Fq(self.0.c1.c2.c0.clone());
        let c11 = Fq(self.0.c1.c2.c1.clone());
