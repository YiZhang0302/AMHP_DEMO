...
public class G2Test {
    ...
    public void testDeserialize(){
        byte[] G2_P_byte = Util.serializeG2(G2_P);
        G2Point G2_PNew = Util.deserializeG2(G2_P_byte);
        System.out.println("G2_PNew = " + G2_PNew.toString());
        System.out.println("G2_P = " + G2_P.toString());
        // assertEquals(G2_P, G2_PNew);
    }
}
