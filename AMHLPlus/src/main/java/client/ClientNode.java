...
public class ClientNode {
    ...
    public HashMap<String, String> forwardMessage(HashMap<String, String> message) {
        ...
        HashMap<String, String> onionMessageMap = this.peelMessage(message);
        this.lockMessage = onionMessageMap;
        // check lock message
        if (!this.checkLockMessage(onionMessageMap)) {
            // check failed
            return null;
        }
        ...
        responseMessage.put("sig", sig);
        responseMessage.put("k", lockMessage.get("k"));
    ...
    public HashMap<String, String> peelMessage(HashMap<String, String> messageMap){
        String paddedOnionMessage = messageMap.get("nextEncOniRouPadMessage");
    ...
    public boolean checkLockMessage(HashMap<String, String> messageMap) {
        ...
        BigInteger k = new BigInteger(messageMap.get("k"));

        BigInteger newY = DiscreteLogarithmTool.modPow(k);
        // BigInteger newY = DiscreteLogarithmTool.modMul(g_k, Y);
        if(!newY.equals(Y)){
            return false;
        }
